	...
	function commonCallBack(obj){
     ...
     //-->
           ...
           <form  id="commonForm" name="commonForm"  method="post"  >
			...
			<input type="hidden" id="img_no"         name="img_no"         class="input-box" value='0'/>
                    ...
                    <table class="detail-tb">
                        ...
                        <tbody>
                            <tr>
                                <th>제목</th>
                                <td>
                                    <input type="text"  id='img_nm' name='img_nm' class="input-box w768" value=""/>
                                </td>
                            </tr>
                            <tr>
                                <th>이미지 업로드</th>
                            ...
                            <tr>
                                <th>링크주소</th>
                                <td>
                                    http:// <input type="text" id='link_url' name='link_url' class="input-box w768" value=""/>
                                </td>
                            </tr>
                        </tbody>
                    </table>
