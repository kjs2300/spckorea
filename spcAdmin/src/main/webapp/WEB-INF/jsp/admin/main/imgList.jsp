           ...
           <div class="table-wrap">
               <table class="list-tb">
                   ...
                   <tbody>
                       ...
                       <tr>
                           <td>${result.img_nm}5555</td>
                           <td><img class="img-box" src="/editor/${mainVo.gubun2}/${result.file_id}.${ppx[1]}" alt="배너스크립트"/></td>
                           <td>${result.img_pos}</td>
                           <td>${result.link_url}</td>
                           <td>${result.reg_dt}</td>
                           <td>
                               <button type='button'   onClick="javascript:fn_save('E','${result.img_no}');" class="sm-btn blue-btn"> 수정</button>
                               <button type='button'   onClick="javascript:fn_delete('D','${result.img_no}');" class="sm-btn white-btn">삭제</button>
                           </td>
                       </tr>
                    </c:forEach>
