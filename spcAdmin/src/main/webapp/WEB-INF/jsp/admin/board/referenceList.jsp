...
<div class="search-wrap">
    <form id="listForm" name="listForm" target="_self" action="/adBoard/referenceList.do" method="post" onsubmit="">
        ...
        <tbody>
        	<c:forEach var="result" items="${resultList}" varStatus="status">
	            <tr>
	                ...
	                <td><button type="button" class="sm-btn blue-btn"  onClick="javascript:fn_edit('${result.board_idx}',  'E', 'referenceList');" >수정</button></td>
