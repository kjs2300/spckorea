...
<h1 class="h1-tit">강사 자료실 ${ not empty detailData.board_idx ? "수정" : "등록"}</h1>

<form id="commonForm" name="commonForm" method="post">
<input type="hidden" name="board_idx" id="board_idx" value="${ not empty detailData.board_idx ? detailData.board_idx : '0'}">
<input type="hidden" name="board_type" id="board_type" value="06">
...
<input type="hidden" id="file_seq"       name="file_seq"       class="input-box" value=0/>
	<div class="table-wrap">
	    <table class="detail-tb">
	        <caption>제목, 공지, 작성자, 패스워드, 읽기권한, 내용, 첨부파일 정보가 있는 테이블</caption>
	        <colgroup>
	            <col width="15%"/>
	            <col width="10%"/>
	            <col width="10%"/>
