...
<div class="search-wrap">
     <form id="listForm" name="listForm" target="_self" action="/adBoard/instructReferList.do" method="post" onsubmit="">
...
<div class="btn-cont mb20">
    <button class="mid-btn blue-btn" onclick="location.href = '<c:url value='/adBoard/instructReferReq.do' />'; ">등록</button>
        ...
        <tbody>
        	<c:forEach var="result" items="${resultList}" varStatus="status">
	            <tr>
	                ...
	                <td><button type="button" class="sm-btn blue-btn"  onClick="javascript:fn_edit('${result.board_idx}',  'E', 'instructReferList');" >수정</button></td>
