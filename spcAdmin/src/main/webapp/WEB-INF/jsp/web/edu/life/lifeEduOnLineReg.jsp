                  ...
                  <div class="table-wrap">
                      <table class="detail-tb">
                          ...
                          <tbody>
                              ...
                              <tr>
                                  <th>휴대폰</th>
                                  <td><input type="text" id="mbl_telno" name="mbl_telno" class="input-box lg-width"  onKeyup="this.value=this.value.replace(/[^0-9]/g,'');"  maxlength="11" placeholder="- 없이 입력해주세요" value=""/></td>
                              </tr>
                              <tr>
                                  <th>이메일</th>
                                  <td>
