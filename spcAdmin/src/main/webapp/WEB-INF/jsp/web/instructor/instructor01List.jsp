     ...
     <!-- container  begin -->
                <div id="container">
                    ...
                    <div class="contents-wrap">
						...
						<input type="hidden" id="board_idx"   name="board_idx"  value="05"/>
                        <!---- search-wrap begin ---->
                                ...
                                <table class="list-tb">
                                    ...
                                    <c:forEach var="result" items="${resultList}" varStatus="status">
                                    	<tr>
							                ...
							                <td class="tl"><a class="link" href="<c:url value='/user/instructor01View.do'/>?board_idx=${result.BOARD_IDX}">${result.TITLE}</a></td>
