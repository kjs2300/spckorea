...
public class MainVo extends DefaultVO
{
  ...
  public void setLogo_no(int logo_no) {
    this.logo_no = logo_no;
  }
  public String getLogo_nm() {
    return this.logo_nm;
  }
  public void setLogo_nm(String logo_nm) {
    this.logo_nm = logo_nm;
  }
